    ...
    <div className="min-h-screen bg-gray-200 flex justify-center relative xl:ml-96 2xl:mx-96 lg:ml-96 md:ml-60 sm:mx-12 min-[400px]:mx-12 min-[380px]:mx-8 md:w-full md:relative md:right-10">
      ...
      <div className="container mx-auto pt-4 relative z-10">
        <form
          ...
          className="mb-4 relative xl:ml-24 2xl:ml-36 lg:ml-20 md:mr-8 sm:ml-32 "
        >
          <input
            type="text"
            name="search"
            placeholder="Buscar una ciudad"
            className=" h-10 rounded-l-lg py-2 px-4 text-slate-900 font-semibold bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm xl:w-2/5 min-[380px]:w-3/5 xl:relative xl:right-24 sm:relative sm:right-32 sm:w-4/5 md:w-2/5 lg:w-2/6 lg:relative lg:right-16 placeholder:font-semibold placeholder:text-slate-300"
          />
          <button
            type="submit"
            className="px-4 bg-blue-500 h-10 md:w-30 text-white font-black rounded-r-lg border border-blue-500 hover:bg-blue-700 min min-[380px]:w-1/3 xl:w-1/6 xl:relative xl:right-24 sm:w-1/5 sm:relative sm:right-32 lg:w-2/12 lg:relative lg:right-16"
          >
            Buscar
          </button>
        </form>
          ...
          <div className="bg-white bg-opacity-20 w-full md:w-2/4 backdrop-filter backdrop-blur-sm p-4 rounded-md md:p-8">
            <div className="flex flex-col md:flex-row justify-between items-center mb-4">
              <div className="mb-4 md:mb-0">
                ...
                <p className="text-lg md:text-xl mt-2 text-black font-bold">
              ...
              <div>
                ...
                <p className="font-semibold text-blue-700">
                  Mínima: {weatherData.temp_min}°{weatherData.unit}
                </p>
                <p className="font-semibold text-red-600">
                  Máxima: {weatherData.temp_max}°{weatherData.unit}
                </p>
                <p className="font-semibold text-green-500">
                  Vientos: {weatherData.wind_speed} km/h
                </p>
                <p className="font-semibold text-cyan-400">
                  Humedad: {weatherData.humidity}%
                </p>
                <p className="font-semibold text-orange-500">
                  Sensación térmica: {weatherData.feels_like}°{weatherData.unit}
                </p>
                <button
                  onClick={toggleTemperatureUnit}
                  className="min-[380px]:ml-8 hover:transform hover:scale-125 text-lg font-bold bg-blue-500 hover:bg-blue-700 text-white rounded-lg w-28 h-10 mt-2 min-[380px]:relative min-[380px]:left-0 "
                >
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-500 text-white rounded-lg border border-blue-500 hover:bg-blue-700 font-bold focus:bg-blue-700 sm:ml-44 min-[400px]:ml-16 xl:ml-32 min-[380px]:ml-16 hover:transform hover:scale-125 md:relative md:right-20 lg:relative lg:right-4 xl:relative xl:right-28 min-[380px]:relative min-[380px]:right-1"
            >
              Agregar a la lista
            </button>
          </div>
